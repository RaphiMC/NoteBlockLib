...
public class MidiInstruments {
    ...
    static {
        final Map<Integer, MidiInstrument> imap = new ConcurrentHashMap<>(128);
        ...
        imap.put(28, new MidiInstrument(-1, 0, false));
        ...
        // Synth Effects
        imap.put(96, new MidiInstrument(-1, 0, false));
        imap.put(97, new MidiInstrument(-1, 0, false));
        ...
        imap.put(101, new MidiInstrument(-1, 0, false));
        imap.put(102, new MidiInstrument(-1, 0, false));
        imap.put(103, new MidiInstrument(-1, 0, false));
        // Ethnic
        ...
        // Sound Effects
        imap.put(119, new MidiInstrument(-1, 0, false));
        imap.put(120, new MidiInstrument(-1, 0, false));
        imap.put(121, new MidiInstrument(-1, 0, false));
        imap.put(122, new MidiInstrument(-1, 0, false));
        imap.put(123, new MidiInstrument(-1, 0, false));
        imap.put(124, new MidiInstrument(-1, 0, false));
        imap.put(125, new MidiInstrument(-1, 0, false));
        imap.put(126, new MidiInstrument(-1, 0, false));
        imap.put(127, new MidiInstrument(0, 0, false));
        instrumentMapping = Collections.unmodifiableMap(imap);


        // ------------------ Percussion  ------------------
        final Map<Integer, MidiPercussion> pmap = new ConcurrentHashMap<>(64);
        pmap.put(24, new MidiPercussion(-1, 0));
        pmap.put(25, new MidiPercussion(-1, 0));
        pmap.put(26, new MidiPercussion(-1, 0));
        pmap.put(27, new MidiPercussion(-1, 0));
        pmap.put(28, new MidiPercussion(-1, 0));
        pmap.put(29, new MidiPercussion(-1, 0));
        pmap.put(30, new MidiPercussion(-1, 0));
        pmap.put(31, new MidiPercussion(-1, 0));
        pmap.put(32, new MidiPercussion(-1, 0));
        pmap.put(33, new MidiPercussion(-1, 0));
        pmap.put(34, new MidiPercussion(-1, 0));
        ...
        pmap.put(71, new MidiPercussion(-1, 0));
        pmap.put(72, new MidiPercussion(-1, 0));
